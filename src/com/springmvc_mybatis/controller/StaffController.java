...
public class StaffController {
    ...
    public void modifyStaff(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        staffMapper.modifyStaff(xm, cym, cbrylb, xb, sfzhm, csrq, sfxz,
                mz, tblb, tblbmc, cjgzsj, jfly, hkxz, dz, dh, grsf, rwsj,
                drsj, zyyy, jyyy, ryid, rydjid, czbm, ygrbh, grbh, jbjgid, xmpy, bz);
